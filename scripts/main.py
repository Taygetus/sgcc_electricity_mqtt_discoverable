...
def main():
    ...
    logging.info(f"The current logged-in user name is {PHONE_NUMBER}, the mqtt address is {MQTT_HOST}, and the program will be executed every day at {JOB_START_TIME}.")
